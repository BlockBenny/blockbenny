      ...
      <section id="about" className="min-h-screen">
        <div className="grid grid-cols-2 gap-2 p-10 min-h-screen">
          <div className="flex justify-center items-center">
            <div className="fullHd:collage0HD 4k:collage0 absolute z-40">
              <Image alt="First of 4 Pics" src={pfp} />
            </div>
            <div className="fullHd:collage1HD 4k:collage1  absolute z-50">
              <Image alt="Second of 4 Pics" src={about1} />
            </div>
            <div className="fullHd:collage2HD 4k:collage2  absolute z-20">
              <Image alt="Third of 4 Pics" src={about2} />
            </div>
            <div className="fullHd:collage3HD 4k:collage3  absolute z-30">
              <Image alt="Fourth of 4 Pics" src={about3} />
            </div>
          </div>
          <div className="4k:mt-48  fullHd:mt-32 4k:text-2xl fullHd:text-md 4k:pr-48 fullHd:pr-24">
